...
namespace UcenjeCS
{
    internal class E08ForEachPetlja
    {
        public static void Izvedi() 
        {
            ...
            string Ime = "Edunova a čšćđĐŽžŠĆČ";
            ...
            char[] JedinstvenaSlova = new char[Unos.Length]; // ne treba mi toliko prostora, najveći nedostatak nizova je taj što se na početku mora reći koliko ima elemenata
            bool postoji;
            index = 0;
            foreach (char c in Unos)
            {
